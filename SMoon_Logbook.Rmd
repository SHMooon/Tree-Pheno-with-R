...
temps <- temperature_generation(Kiel_temps, years = c(1973, 2019), 
                                sim_years = c(2001, 2100), 
...
save_temperature_scenarios(temps,"data/Kiel_future_climate","Kiel_future")
temps <- load_temperature_scenarios("data/Kiel_future_climate","Kiel_future")
...
save_temperature_scenarios(chill_future_scenario_list,"data/Kiel_future_climate","Kiel_futurechill")



chill_future_scenario_list <- load_temperature_scenarios("data/Kiel_future_climate","Kiel_futurechill")


chill_hist_scenario_list<-load_temperature_scenarios("data","Kiel_hist_chill_305_59")
observed_chill <- read_tab("data/Kiel_observed_chill_305_59.csv")
...
Kiel_chill_hist_scenario_list <- load_temperature_scenarios("data",
                                                       "Kiel_hist_chill_305_59")
actual_chill <- read_tab("data/Kiel_observed_chill_305_59.csv")

Kiel_chill_future_scenario_list <- load_temperature_scenarios("data/future_climate",
                                                         "Kiel_futurechill")

chills <- make_climate_scenario(
  Kiel_chill_hist_scenario_list,
  caption = "Historic",
...
list_ssp <- 
  strsplit(names(Kiel_chill_future_scenario_list), '\\.') %>%
  map(2) %>%
  unlist()
...
for(SSP in SSPs)
  for(Time in Times)
    ...
    # find all scenarios for the ssp and time
    chill <- Kiel_chill_future_scenario_list[list_ssp == SSP & list_time == Time]
    names(chill) <- list_gcm[list_ssp == SSP & list_time == Time]
    if(SSP == "ssp126") SSPcaption <- "SSP1"
    if(SSP == "ssp245") SSPcaption <- "SSP2"
    if(SSP == "ssp585") SSPcaption <- "SSP5"    

...
chill_phase <- c(317, 62) #around end of november and early february
...
mean_temp_period <- function(
    temps,
    start_JDay,
    end_JDay, #set end of December open for all year 
    end_season = end_JDay) #end of blooming 
...
#remove these days: lot of different of n_days 
mean_temp_chill <- 
...
#2. look the data from other citys that we have: Beijing, Tunisia 
